    ...
    case CAUSE_MEXTERNEL_S_TRAP:
      {
        ...
        *ctrl_reg = *ctrl_reg | (1 << 4);
        // TODO (lab4_2): implment the case of CAUSE_MEXTERNEL_S_TRAP.
        // hint: the case of CAUSE_MEXTERNEL_S_TRAP is to get data from UART address and wake the process. therefore,
        // and you need to store the data in struct process.value.
        panic( "You have to implement CAUSE_MEXTERNEL_S_TRAP to get data from UART and wake the process 0 in lab4_2.\n" );
