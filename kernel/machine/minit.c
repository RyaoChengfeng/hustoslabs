...
// following two variables are added @lab4_2
...
//
// set plic priority to the highest. added @lab4_2
//
void plic_init() {
...
void m_start(uintptr_t hartid, uintptr_t dtb) {
  ...
  spike_file_init();
  // query_uart is added @lab4_1
  query_uart(dtb);
  sprint("In m_start, hartid:%d\n", hartid);

  // init plic. added @lab4_2
  query_plic(dtb);
  plic_init();
  hart_plic_init();
  ...
  // init bluetooth external interrupt. added @lab4_2
